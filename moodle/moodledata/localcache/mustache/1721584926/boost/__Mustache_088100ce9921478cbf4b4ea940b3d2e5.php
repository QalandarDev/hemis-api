...
class __Mustache_088100ce9921478cbf4b4ea940b3d2e5 extends Mustache_Template
{
...
';
        ...
        $buffer .= $this->section9671de6726d6c4a6270147cc6f99eabd($context, $indent, $value);
        $buffer .= $indent . '        </div>
';
        $buffer .= $indent . '    </div>
';
...
';
    ...
    private function section9671de6726d6c4a6270147cc6f99eabd(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
                    ...
                    <div class="box box-widget widget-user">
                        ...
                        <div class="box-footer no-padding">
                            <ul class="nav nav-stacked">
                                <li>
                                    <a href="/course/view.php?id={{course_id}}&filter=resource" data-pjax="0">
                                    Resurslar soni
...
';
                $buffer .= $indent . '                                <li>
';
                $buffer .= $indent . '                                    <a href="#" data-pjax="0">
';
