...
class __Mustache_ed2e9a26718b2bf6361c70a5809f09c0 extends Mustache_Template
{
    public function renderInternal(Mustache_Context $context, $indent = '')
    {
        $buffer = '';

        $buffer .= $indent . '<link rel="stylesheet" href="https://student.mamunedu.uz/assets/93dad33b/dist/css/AdminLTE.min.css?v=1567066820">
';
...
';
        $buffer .= $indent . '    <div id="attendance-grid" data-pjax-container=""><div class="info-box box-mini">
';
...
';
        $buffer .= $indent . '        <div class="row">
';
        $buffer .= $indent . '            <div class="col col-md-4">
';
...
';
        $buffer .= $indent . '                        <h4 class="widget-user-username">Amaliy matematika 2</h4>
';
        $buffer .= $indent . '                        <h5 class="widget-user-desc">
';
        $buffer .= $indent . '                            Majburiy |
';
        $buffer .= $indent . '                            180 soat                            | 6.0 kredit                        </h5>
';
        $buffer .= $indent . '                    </div>
';
...
';
        $buffer .= $indent . '                    <div class="widget-user-header bg-blue">
';
        $buffer .= $indent . '                        <h4 class="widget-user-username">Iqtisodiyot nazariyasi 1</h4>
';
        $buffer .= $indent . '                        <h5 class="widget-user-desc">
';
        $buffer .= $indent . '                            Majburiy |
...
';
        $buffer .= $indent . '                    <div class="widget-user-header bg-blue">
';
        $buffer .= $indent . '                        <h4 class="widget-user-username">Xorijiy til 1</h4>
';
        $buffer .= $indent . '                        <h5 class="widget-user-desc">
';
        $buffer .= $indent . '                            Majburiy |
';
        $buffer .= $indent . '                            120 soat                            | 4.0 kredit                        </h5>
';
        $buffer .= $indent . '                    </div>
';
        $buffer .= $indent . '                    <div class="box-footer no-padding">
...
';
        $buffer .= $indent . '                    <div class="widget-user-header bg-blue">
';
        $buffer .= $indent . '                        <h4 class="widget-user-username">Dinshunoslik</h4>
';
        $buffer .= $indent . '                        <h5 class="widget-user-desc">
';
        $buffer .= $indent . '                            Majburiy |
...
';
        $buffer .= $indent . '                    <div class="widget-user-header bg-blue">
';
        $buffer .= $indent . '                        <h4 class="widget-user-username">O\'zbek (rus) tili</h4>
';
        $buffer .= $indent . '                        <h5 class="widget-user-desc">
';
        $buffer .= $indent . '                            Majburiy |
