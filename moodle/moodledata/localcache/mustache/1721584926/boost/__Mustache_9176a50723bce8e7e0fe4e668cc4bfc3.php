...
class __Mustache_9176a50723bce8e7e0fe4e668cc4bfc3 extends Mustache_Template
{
...
';
        ...
        $buffer .= $this->section5fc84b6cfbb8ef0729c5dd71c61d9af7($context, $indent, $value);
        $buffer .= $indent . '        </div>
';
        $buffer .= $indent . '    </div>
';
...
';
    ...
    private function section5fc84b6cfbb8ef0729c5dd71c61d9af7(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
                ...
                <div class="col col-md-6">
                    ...
                    <div class="box box-widget widget-user">
                        ...
                        <div class="widget-user-header bg-blue">
                            <h5 class="widget-user-username">{{fullname}}</h5>
                            <h6 class="widget-user-desc">
                                Majburiy |
                                180 soat | 6.0 kredit </h6>
                        </div>
                        <div class="box-footer no-padding">
                            <ul class="nav nav-stacked">
                                <li>
                                    <a href="/education/resources?subject="{{id}} data-pjax="0">
                                        Resurslar soni <span class="pull-right badge bg-blue">
                                        15                                    </span>
                                    </a>
                                </li>
                                <li>
...
';
                $buffer .= $indent . '                                <li>
';
                $buffer .= $indent . '                                    <a href="/education/resources?subject="';
