...
class __Mustache_4e80acfe8056272612c8fee56491ac25 extends Mustache_Template
{
...
';
        ...
        $buffer .= $this->sectionDec05ffa29e428803ae2d9c6fd190ffc($context, $indent, $value);
        $buffer .= $indent . '        </div>
';
        $buffer .= $indent . '    </div>
';
...
';
    ...
    private function sectionDec05ffa29e428803ae2d9c6fd190ffc(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
                ...
                <div class="col col-md-6">
                    ...
                    <div class="box box-widget widget-user">
                        ...
                        <div class="widget-user-header bg-blue">
                            <h5 class="widget-user-username">Amaliy matematika 2</h5>
                        ...
                        <div class="box-footer no-padding">
                            <ul class="nav nav-stacked">
                                <li>
                                    <a href="/education/resources?subject=207" data-pjax="0">
