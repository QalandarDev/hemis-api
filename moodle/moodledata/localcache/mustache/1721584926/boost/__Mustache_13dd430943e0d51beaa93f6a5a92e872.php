...
class __Mustache_13dd430943e0d51beaa93f6a5a92e872 extends Mustache_Template
{
...
';
        $buffer .= $indent . '                        <h6 class="widget-user-username">Amaliy matematika 2</h6>
';
...
';
        $buffer .= $indent . '                    <div class="widget-user-header bg-blue">
';
        $buffer .= $indent . '                        <h6 class="widget-user-username">Iqtisodiyot nazariyasi 1</h6>
';
        $buffer .= $indent . '                        <h5 class="widget-user-desc">
';
        $buffer .= $indent . '                            Majburiy |
...
';
        $buffer .= $indent . '                    <div class="widget-user-header bg-blue">
';
        $buffer .= $indent . '                        <h6 class="widget-user-username">Xorijiy til 1</h6>
';
        $buffer .= $indent . '                        <h5 class="widget-user-desc">
';
        $buffer .= $indent . '                            Majburiy |
...
';
        $buffer .= $indent . '                    <div class="widget-user-header bg-blue">
';
        $buffer .= $indent . '                        <h6 class="widget-user-username">Dinshunoslik</h6>
';
        $buffer .= $indent . '                        <h5 class="widget-user-desc">
';
        $buffer .= $indent . '                            Majburiy |
...
';
        $buffer .= $indent . '                    <div class="widget-user-header bg-blue">
';
        $buffer .= $indent . '                        <h6 class="widget-user-username">O\'zbek (rus) tili</h6>
';
        $buffer .= $indent . '                        <h5 class="widget-user-desc">
';
        $buffer .= $indent . '                            Majburiy |
