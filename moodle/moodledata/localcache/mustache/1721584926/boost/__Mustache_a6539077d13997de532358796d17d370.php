...
class __Mustache_a6539077d13997de532358796d17d370 extends Mustache_Template
{
...
';
        ...
        $buffer .= $this->section1c60343ec059e2c4980bb46c115cd695($context, $indent, $value);
        $buffer .= $indent . '        </div>
';
        $buffer .= $indent . '    </div>
';
...
';
    ...
    private function section1c60343ec059e2c4980bb46c115cd695(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
                    ...
                    <div class="box box-widget widget-user">
                        ...
                        <div class="box-footer no-padding">
                            <ul class="nav nav-stacked">
                                <li>
                                    <a href="/course/view.php?id={{id}}" data-pjax="0">
