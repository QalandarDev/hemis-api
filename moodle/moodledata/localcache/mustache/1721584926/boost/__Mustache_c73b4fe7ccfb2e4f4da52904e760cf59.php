...
class __Mustache_c73b4fe7ccfb2e4f4da52904e760cf59 extends Mustache_Template
{
...
';
        ...
        $buffer .= $this->sectionD1eb25832f1a96d6ecf224d16f2b1725($context, $indent, $value);
        $buffer .= $indent . '        </div>
';
        $buffer .= $indent . '    </div>
';
...
';
    ...
    private function sectionD1eb25832f1a96d6ecf224d16f2b1725(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
                    ...
                    <div class="box box-widget widget-user">
                        ...
                        <div class="box-footer no-padding">
                            <ul class="nav nav-stacked">
                                <li>
                                    <a href="/course/resource/{{id}}" data-pjax="0">
...
';
                $buffer .= $indent . '                                <li>
';
                $buffer .= $indent . '                                    <a href="/course/resource/';
