...
class __Mustache_a555f00549ae2b76cea743f3184a56c9 extends Mustache_Template
{
...
';
        ...
        $buffer .= $this->sectionDd21ee567f49cbd0b67a6ca2dee36285($context, $indent, $value);
        $buffer .= $indent . '        </div>
';
        $buffer .= $indent . '    </div>
';
...
';
    ...
    private function sectionDd21ee567f49cbd0b67a6ca2dee36285(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
...
';
                ...
                $value = $this->resolveValue($context->findDot('5.id'), $context);
                $buffer .= ($value === null ? '' : call_user_func($this->mustache->getEscape(), $value));
                $buffer .= '" data-pjax="0">
';
