...
class __Mustache_bace7cd21d37d520e471e9af2da28f1e extends Mustache_Template
{
...
';
        ...
        $buffer .= $this->section1789908254f6733fe7bb0033b338d291($context, $indent, $value);
        $buffer .= $indent . '        </div>
';
        $buffer .= $indent . '    </div>
';
...
';
    ...
    private function section1789908254f6733fe7bb0033b338d291(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
                    ...
                    <div class="box box-widget widget-user">
                        ...
                        <div class="widget-user-header bg-blue">
                            ...
                            <h6 class="widget-user-desc">
                                Majburiy |
                                {{total_acload}} soat | 6.0 kredit </h6>
                        </div>
